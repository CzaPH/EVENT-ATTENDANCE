    ...
    <div class="container-fluid">
        <div class="row p-2" style="background:#0A2558; color:#FFF">
            ...
            <div class="col-sm-9 small">
                <form action="" method="POST" id="search" style="float:left;">
                    <b>
                        SEMESTER :
                        <?=$semester?>
                    </b>
                ...
                <form action="" method="POST" id="form">
                    SUBJECT :
                    <select name="class_id" id="class_id" class="p-2" style="width:100px;" required>
                        ...
                        <tr>
                            ...
                            <?php foreach($result3 as $row3):
                                $query_3 = $conn->prepare("SELECT *
                                                            FROM 
                                                            tblattendance
                                                                WHERE fk_subject_id = ? AND fk_student_id = ? AND schedule_id = ?");
                                $query_3->bind_param('iis', $class_id, $row2['id'], $row3['schedule_id']);
